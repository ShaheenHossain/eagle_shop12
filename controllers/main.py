...
class EagleshopSliderSettings(http.Controller):
    ...
    @http.route(['/theme_eagleshop/blog_get_options'], type='json', auth="public", website=True)
    ...
    @http.route(['/theme_eagleshop/blog_get_dynamic_slider'], type='http', auth='public', website=True)
    def eagleshop_get_dynamic_slider(self, **post):
        if post.get('slider-type'):
            ...
            return request.render("theme_eagleshop.theme_eagleshop_blog_slider_view", values)

    @http.route(['/theme_eagleshop/blog_image_effect_config'], type='json', auth='public', website=True)
    ...
    # For Client slider
    @http.route(['/theme_eagleshop/get_clients_dynamically_slider'], type='http', auth='public', website=True)
    def get_clients_dynamically_slider(self, **post):
        ...
        return request.render("theme_eagleshop.theme_eagleshop_client_slider_view", values)

    # For multi product slider
    @http.route(['/theme_eagleshop/product_multi_get_options'], type='json', auth="public", website=True)
    ...
    @http.route(['/theme_eagleshop/product_multi_get_dynamic_slider'], type='http', auth='public', website=True)
    def eagleshop_product_multi_get_dynamic_slider(self, **post):
        ...
        if post.get('slider-type'):
            ...
            return request.render("theme_eagleshop.theme_eagleshop_multi_cat_slider_view", values)

    @http.route(['/theme_eagleshop/product_multi_image_effect_config'], type='json', auth='public', website=True)
    ...
    @http.route(['/theme_eagleshop/newsone_get_dynamic_slider'], type='http', auth='public', website=True)
    def eagleshop_get_dynamic_newsone_slider(self, **post):
        if post.get('slider-type'):
            ...
            return request.render("theme_eagleshop.theme_eagleshop_news1_view", values)

    @http.route(['/theme_eagleshop/newstwo_get_dynamic_slider'], type='http', auth='public', website=True)
    def eagleshop_get_dynamic_newstwo_slider(self, **post):
        if post.get('slider-type'):
            ...
            return request.render("theme_eagleshop.theme_eagleshop_news2_view", values)

    @http.route(['/theme_eagleshop/theme_new_hardware_blog'], type='http', auth='public', website=True)
    def eagleshop_get_dynamic_hardwareblog_slider(self, **post):
        if post.get('slider-type'):
            ...
            return request.render("theme_eagleshop.theme_eagleshop_hardware_blog_snippet_view", values)

    # Coming soon snippet
    @http.route(['/biztech_comming_soon/soon_data'], type="http", auth="public", website=True)
    def get_soon_data(self, **post):
        return request.render("theme_eagleshop.theme_eagleshop_coming_soon_mode_one_view")

    @http.route(['/biztech_comming_soon_two/two_soon_data'], type="http", auth="public", website=True)
    def get_soon_data_two(self, **post):
        return request.render("theme_eagleshop.theme_eagleshop_coming_soon_mode_two_view")
    ...
    def get_one_employee_details_custom(self, **post):
        ...
        return request.render("theme_eagleshop.theme_eagleshop_team_one", emp)

    @http.route(['/biztech_emp_data/employee_data'], type="http", auth="public", website=True)
    def get_employee_detail_custom(self, **post):
        emp = self.find_snippet_employee()
        return request.render("theme_eagleshop.theme_eagleshop_team_two", emp)
    ...
    def get_employee_detail_custom_1(self, **post):
        emp = self.find_snippet_employee()
        return request.render("theme_eagleshop.theme_eagleshop_team_three", emp)

    # For Category slider
    @http.route(['/theme_eagleshop/category_get_options'], type='json', auth="public", website=True)
    ...
    @http.route(['/theme_eagleshop/category_get_dynamic_slider'], type='http', auth='public', website=True)
    def category_get_dynamic_slider(self, **post):
        if post.get('slider-id'):
            ...
            return request.render("theme_eagleshop.theme_eagleshop_cat_slider_view", values)

    @http.route(['/theme_eagleshop/category_image_effect_config'], type='json', auth='public', website=True)
    ...
    def get_factsheet_data(self, **post):
        return request.render("theme_eagleshop.theme_eagleshop_facts_sheet_view")

    @http.route(['/biztech_skill_model_data/skill_data'], type="http", auth="public", website="True")
    def get_skill_data(self, **post):
        return request.render("theme_eagleshop.theme_eagleshop_skills_view")

    # Multi image gallery
    @http.route(['/theme_eagleshop/eagleshop_multi_image_effect_config'], type='json', auth="public", website=True)
    ...
    # For Product slider
    @http.route(['/theme_eagleshop/product_get_options'], type='json', auth="public", website=True)
    ...
    @http.route(['/theme_eagleshop/product_get_dynamic_slider'], type='http', auth='public', website=True)
    def product_get_dynamic_slider(self, **post):
        if post.get('slider-id'):
            ...
            return request.render("theme_eagleshop.theme_eagleshop_product_slider_view", values)

    @http.route(['/theme_eagleshop/product_image_effect_config'], type='json', auth='public', website=True)
    ...
    @http.route(['/theme_eagleshop/featured_product_get_options'], type='json', auth="public", website=True)
    ...
    @http.route(['/theme_eagleshop/featured_product_get_dynamic_slider'], type='http', auth='public', website=True)
    def featured_product_get_dynamic_slider(self, **post):
        ...
        if post.get('slider-id'):
            ...
            return request.render("theme_eagleshop.theme_eagleshop_featured_product_slider_view", values)

    @http.route(['/theme_eagleshop/featured_product_image_effect_config'], type='json', auth='public', website=True)
    ...
    @http.route(['/theme_eagleshop/event_slider/get_data'], type="http", auth="public", website=True)
    def get_event_data(self, **post):
        events = request.env['event.type'].sudo().search([])
        values = {'main_events_category': events}
        return request.render("theme_eagleshop.theme_eagleshop_events_view", values)
...
class EagleshopEcommerceShop(WebsiteSale):
    ...
    def cart_update_json(self, product_id, line_id=None, add_qty=None, set_qty=None, display=True):
        ...
        result.update({'theme_eagleshop.hover_total': request.env['ir.ui.view'].render_template("theme_eagleshop.hover_total", {
    ...
    def shop(self, page=0, category=None, search='', ppg=False, **post):
        ...
        is_price_slider = request.env.ref(
            'theme_eagleshop.product_price_slider')

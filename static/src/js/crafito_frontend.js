odoo.define('theme_eagleshop.eagleshop_frontend_js', function(require) {
    ...
    animation.registry.theme_eagleshop_blog_custom_snippet = animation.Class.extend({
        selector: ".eagleshop_blog_slider",
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $blog_snip = $('#wrapwrap').find('#theme_eagleshop_custom_blog_snippet');
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_eagleshop/blog_get_dynamic_slider", {
                    ...
                    if (data) {
                        ...
                        ajax.jsonRpc('/theme_eagleshop/blog_image_effect_config', 'call', {
    ...
    animation.registry.s_theme_eagleshop_client_slider_snippet = animation.Class.extend({
        selector: ".our-client-slider",
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $client_slider = $('#wrapwrap').find('#theme_eagleshop_custom_client_slider');
            ...
            if (!this.editableMode) {
                $.get("/theme_eagleshop/get_clients_dynamically_slider", {}).done(function(data) {
                    if (data) {
                        self.$target.empty();
                        self.$target.append(data);
    ...
    animation.registry.theme_eagleshop_multi_cat_custom_snippet = animation.Class.extend({
        selector: ".oe_multi_category_slider",
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $cat_custom = $('#wrapwrap').find('#theme_eagleshop_custom_multi_product_tab_slider');
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_eagleshop/product_multi_get_dynamic_slider", {
    ...
    animation.registry.theme_eagleshop_coming_soon_mode_one = animation.Class.extend({
    ...
    animation.registry.theme_eagleshop_coming_soon_mode_two = animation.Class.extend({
    ...
    animation.registry.theme_eagleshop_category_slider = animation.Class.extend({
        selector: ".oe_cat_slider",
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $cate_slider = $('#wrapwrap').find('#theme_eagleshop_custom_category_slider');
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_eagleshop/category_get_dynamic_slider", {
                    ...
                    if (data) {
                        ...
                        ajax.jsonRpc('/theme_eagleshop/category_image_effect_config', 'call', {
                            'slider_id': slider_id
                        }).done(function(res) {
                            $('div#' + res.s_id).owlCarousel({
                                margin: 10,
    ...
    animation.registry.theme_eagleshop_product_slider = animation.Class.extend({

        selector: ".oe_prod_slider",
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $prod_slider = $('#wrapwrap').find('#theme_eagleshop_custom_product_slider');
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_eagleshop/product_get_dynamic_slider", {
                    ...
                    if (data) {
                        ...
                        ajax.jsonRpc('/theme_eagleshop/product_image_effect_config', 'call', {
                            'slider_id': slider_id
                        }).done(function(res) {
                            $('div#' + res.s_id).owlCarousel({
                                margin: 10,
    ...
    animation.registry.theme_eagleshop_featured_product_slider = animation.Class.extend({
        ...
        start: function() {
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_eagleshop/featured_product_get_dynamic_slider", {
    ...
    animation.registry.biztech_new_theme_fact_sheet_jsselector = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $skill_selector = $('#wrapwrap').find('.s_theme_eagleshop_facts_sheet');
    ...
    animation.registry.biztech_new_theme_skill_jsselector = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $skill_selector = $('#wrapwrap').find('.s_theme_eagleshop_skills');
    ...
    animation.registry.s_biztech_new_theme_team_two = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $team_two = $('#wrapwrap').find('#theme_eagleshop_custom_second_team');
    ...
    animation.registry.s_biztech_new_theme_team_one = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $team_one = $('#wrapwrap').find('#theme_eagleshop_custom_colthree_team');
    ...
    animation.registry.s_biztech_new_theme_team_three = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $team_three = $('#wrapwrap').find('#theme_eagleshop_three_custom_team');
    ...
    animation.registry.theme_eagleshop_news1_js = animation.Class.extend({
        selector: ".eagleshop_newsone_slider",
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $news1 = $('#wrapwrap').find('#theme_eagleshop_custom_news1');
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_eagleshop/newsone_get_dynamic_slider", {
    ...
    animation.registry.theme_eagleshop_news2_js = animation.Class.extend({
        selector: ".eagleshop_newstwo_slider",
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $news2 = $('#wrapwrap').find('#theme_eagleshop_custom_second_news');
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_eagleshop/newstwo_get_dynamic_slider", {
    ...
    animation.registry.theme_eagleshop_hardware_blog_snippet = animation.Class.extend({
        selector: ".theme_eagleshop_new_blog",
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $blog_snipet = $('#wrapwrap').find('#theme_eagleshop_hardware_blog_inner_containt');
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_eagleshop/theme_new_hardware_blog", {
                    'slider-type': self.$target.attr('data-hardware-newblog-slider-type') || '',
                }).then(function(data) {
                    if (data) {
                        self.$target.empty();
                        self.$target.append(data);
                        $(".theme_eagleshop_new_blog").removeClass('o_hidden');
                    }
                });
            }
        }
    ...
    animation.registry.s_theme_eagleshop_events = animation.Class.extend({
        selector: ".event_category",
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $events= $('#wrapwrap').find('#theme_eagleshop_custom_event_category');
            ...
            if (!this.editableMode) {
                $.get("/theme_eagleshop/event_slider/get_data", {}).then(function(data) {
                    if (data) {
                        self.$target.empty();
                        self.$target.append(data);
                    }

eagle.define('theme_eagleshop.eagleshop_custom_js', function(require) {
    'use strict';
    ...
    $(document).ready(function($) {
        ...
        // Multi image gallery
        var api;
        ajax.jsonRpc('/theme_eagleshop/eagleshop_multi_image_effect_config', 'call', {})
            .done(function(res) {
                var dynamic_data = {}
        ...
        $('.oe_website_sale').each(function() {
            ...
            $(oe_website_sale).on("change", ".oe_cart input.js_quantity[data-product-id]", function() {
                ...
                clickwatch(function() {
                    ...
                    var $q1 = $(".theme_eagleshop_cart_quantity");
                    if (value) {
                        $q1.parent().parent().removeClass("o_hidden");
                    } else {
                        $q1.parent().parent().find('.theme_eagleshop_cart_quantity').html(0)
                    ...
                    ajax.jsonRpc("/shop/cart/update_json", 'call', {
                        ...
                        var my_hover_total = setInterval(function(){
                            ...
                            $("#eagleshop_hover_total").empty().html(data['theme_eagleshop.hover_total']);
